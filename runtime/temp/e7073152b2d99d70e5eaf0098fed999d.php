<?php /*a:3:{s:77:"F:\aProjectDevelopment\qianxun\application\generate\view\view\table_edit.html";i:1554892859;s:71:"F:\aProjectDevelopment\qianxun\application\generate\view\view\base.html";i:1554892859;s:71:"F:\aProjectDevelopment\qianxun\application\generate\view\view\head.html";i:1554892859;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="table_index">
    ...
    <div class="row">
        ...
        <div>
            <a href="<?php echo url('/generate'); ?>" class="btn btn-primary">返回首页</a>
        </div>
    </div>
</div>
    ...
    const table = new Vue({
        ...
        methods: {
            ...
            get_table_info(){
                const that = this;
                $.ajax({
                    url:"<?php echo url('/generate/Api/get_table_info'); ?>",
                    type:"POST",
                    data:{
                        id:that.table_id
                    },
            ...
            del_field(id){
                if (confirm("是否要删除这个字段？")){
                    const that = this;
                    $.ajax({
                        url:"<?php echo url('/generate/Api/delete_field'); ?>",
                        type:"POST",
                        data:{
                            'id': id
                        },
            ...
            add_field(event){
                ...
                $.ajax({
                    url:"<?php echo url('/generate/Api/alter_table_add'); ?>",
                    type:"POST",
                    data:data,
                    async:true,
                    success:function (res) {
